...
const WhoIM = () => {
  return (
    ...
    />
    <div className="w-full lg:w-1/2 h-1/2 lg:h-full flex items-center justify-center flex-col my-10 z-20">
        ...
        <span className="flex flex-col gap-3 text-white items-start  text-base justify-center font-thin lg:text-lg">
            <p className="text-start mt-3 mx-auto md:mx-0">
                I'm a Senior Frontend Developer based in Milan with 8+ years of experience in JavaScript, React, Angular, Vue, Next.js, Node.js, and Express.js. 
                <br />I build high-performance, scalable web applications, from blogging platforms to e-commerce solutions.
                <br />Passionate about UI/UX, I craft responsive, optimized, and engaging user experiences, blending design best practices with cutting-edge frontend technologies.
                <br />Recently, I've also been working with AI/ML to build smart automation bots and leveraging Docker and Kubernetes to streamline deployment in modern cloud environments.
                <ul className="list-none pl-5 space-y-2 mt-2">
                    ...
                    <li>🤖 <strong>AI & DevOps Integration:</strong> Building intelligent bots and using Docker/Kubernetes for seamless, scalable deployments.</li>
            ...
            <FaHandPointRight /> AI & Automation
            <FaHandPointRight /> DevOps (Docker & Kubernetes)
            </span>
        </span>
        </div>
    </div>
