...
const ProjectCard = ({ name, about, image, demo, mobile, code, note }) => {
  return (
          ...
          <div className="flex justify-center">
            ...
            {mobile && (
              <a href={mobile} target="_blank" rel="noreferrer">
                <button className="ml-4 inline-flex text-white bg-purple-700 border-0 py-2 px-5 focus:outline-none font-medium items-center justify-center gap-1 hover:bg-purple-500  rounded text-lg">
                  Android <BiLinkExternal />
                </button>
              </a>
            )}
